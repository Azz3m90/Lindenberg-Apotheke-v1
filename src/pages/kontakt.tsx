              ...
              <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="medikation">Medikationsfrage</option>
                      <option value="reise">Reiseberatung</option>
                      <option value="kompression">Kompressionsstrümpfe</option>
                      <option value="verleih">Verleih-Service</option>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 text-center">
                  <p className="text-sm text-gray-600">
                    Oder rufen Sie uns direkt an für eine sofortige Beratung:
                  </p>
                  <a
                    href="tel:+493677888888"
                    className="inline-flex items-center mt-2 text-primary-600 hover:text-primary-700 font-semibold"
                  >
                    <Phone className="w-4 h-4 mr-2" />
                    03677 888888
                  </a>
